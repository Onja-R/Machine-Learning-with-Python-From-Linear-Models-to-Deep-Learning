...
for i in lambdas:
    print(f'Linear Regression test_error for lambda = {i} :', run_linear_regression_on_MNIST(lambda_factor=i))
...
# C = 0.001 -> Error = 0.0076
# C = 0.0001 -> Error = 0.01009
# C = 0.01 -> Error = 0.0072
# C = 0.1 -> Error = 0.0075
# C = 1 -> Error = 0.0084
# C = 10 -> Error = 0.0097
...
print(f'SVM one vs. rest test_error: {run_svm_one_vs_rest_on_MNIST()}')
# C, error_list = run_svm_one_vs_rest_on_MNIST()
# for c, error in zip(C, error_list):
#     print(f'For C={c}, error is {error:.4f}')
...
print(f'Test error of softmax with mod 3: {run_softmax_on_MNIST_mod3()}.')
